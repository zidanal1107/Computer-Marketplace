        ...
        <div className={`min-h-screen ${bg} flex items-center justify-center px-4`}>
            <div className={`${bgCard} rounded-2xl p-8 w-full max-w-md shadow-xl`}>
                ...
                <p className={`text-center text-sm mt-6 ${textMuted}`}>
                    Belum punya akun?{" "}
                    <button onClick={() => navigate("/register")} className="text-blue-500 underline font-semibold">
                        Daftar sekarang
                    </button>
                    {" "}atau{" "}
                    <button onClick={() => navigate("/")} className="text-blue-500 underline font-semibold">
                        tetap logout
                    </button>
                </p>
            </div>
