...
function Home() {
    ...
    useEffect(() => {
        ...
        animate(".product-card", { opacity: { from: 0, to: 1 }, translateY: { from: 50, to: 0 }, duration: 800, delay: stagger(150), easing: "easeOutExpo" });
    }, []);
            ...
            <section className="px-6 py-16 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} onClick={() => navigate(item.path)} className={`product-card opacity-0 ${bgCard} border-t-4 ${item.warna} rounded-xl p-8 hover:shadow-lg transition cursor-pointer hover:scale-105`}>
            ...
            <section className={`px-6 py-16 ${bgSection}`}>
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            { nama: "Laptop ASUS VivoBook", harga: "Rp 7.500.000", kategori: "Laptop", icon: "💻", stok: "Tersedia" },
                            { nama: "Lenovo ThinkPad X1", harga: "Rp 15.000.000", kategori: "Laptop", icon: "💻", stok: "Tersedia" },
                            { nama: "RAM DDR4 16GB", harga: "Rp 450.000", kategori: "Hardware", icon: "🔩", stok: "Tersedia" },
                            { nama: "SSD NVMe 512GB", harga: "Rp 750.000", kategori: "Hardware", icon: "💾", stok: "Tersedia" },
                            { nama: "PC Gaming Rakitan", harga: "Rp 12.000.000", kategori: "Komputer", icon: "🖥️", stok: "Tersedia" },
                            { nama: "VGA RTX 4060", harga: "Rp 5.500.000", kategori: "Hardware", icon: "🎮", stok: "Tersedia" },
                            { nama: 'Monitor 24" FHD', harga: "Rp 2.200.000", kategori: "Aksesoris", icon: "🖥️", stok: "Tersedia" },
                            { nama: "Keyboard Mechanical", harga: "Rp 350.000", kategori: "Aksesoris", icon: "⌨️", stok: "Tersedia" },
                        ].map((produk, i) => (
                            <div key={i} className={`product-card opacity-0 ${bgCard2} rounded-xl p-4 hover:shadow-lg transition`}>
                                ...
                                <p className="text-green-500 text-xs mb-2">✅ {produk.stok}</p>
                                <div className="flex justify-between items-center">
                                    <span className="text-blue-500 font-bold text-xs md:text-sm">{produk.harga}</span>
                                    <button onClick={() => navigate("/produk")} className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded-full text-xs transition">
                                        + Beli
                                    </button>
                                </div>
                            </div>
            ...
            <section className="px-6 py-16 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className={`product-card opacity-0 ${bgCard} rounded-xl p-8 border ${isDark ? "border-gray-700 hover:border-blue-500" : "border-gray-200 hover:border-blue-400"} transition`}>
